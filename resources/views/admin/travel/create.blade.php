...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/admin/travel/create.css') }}">
                ...
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden scale-in-center">
                    <div class="card-header bg-gradient-primary text-white p-4 border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-0 fw-bold">Tambah Jadwal Travel</h4>
                                <p class="mb-0 opacity-75">Silahkan lengkapi informasi jadwal di bawah ini</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 fade-in" style="--delay: 0.2s">
                                    ...
                                    <div class="input-group input-group-lg has-validation">
                                        <input type="date" id="departure_date" name="departure_date" class="form-control @error('departure_time') is-invalid @enderror" value="{{ old('departure_date') }}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 fade-in" style="--delay: 0.3s">
                                    ...
                                    <div class="input-group input-group-lg has-validation">
                                        <input type="time" id="departure_time" name="departure_time" class="form-control @error('departure_time') is-invalid @enderror" value="{{ old('departure_time') }}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 fade-in" style="--delay: 0.4s">
                                    <div class="form-floating">
                                        <input type="number" id="quota" name="quota" class="form-control form-control-lg @error('quota') is-invalid @enderror" value="{{ old('quota') }}" min="1" placeholder="Masukkan kuota" required>
                                        <label for="quota">
                                    ...
                                    <div class="form-text mt-2">
                                        <div class="d-flex align-items-center">
                                            <input type="range" class="form-range me-2" id="quotaRange" min="1" value="{{ old('quota') }}">
                                            <span id="quotaValue">0</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 fade-in" style="--delay: 0.5s">
                                    <div class="form-floating">
                                        <input type="number" id="price" name="price" class="form-control form-control-lg @error('price') is-invalid @enderror" value="{{ old('price') }}" min="0" placeholder="Masukkan harga" required>
                                        <label for="price">
    ...
    <script src="{{ asset('js/admin/travel/create.js') }}"></script>
@endsection