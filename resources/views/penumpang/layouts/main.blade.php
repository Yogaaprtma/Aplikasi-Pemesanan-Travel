...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/penumpang/main.css') }}">
    @yield('styles')
</head>
<body>
    <div class="overlay"></div>
    <div class="d-flex">
        @include('penumpang.layouts.sidebar')
            ...
            <nav class="navbar navbar-expand-lg navbar-light sticky-top">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand d-none d-lg-block animate__animated animate__fadeIn" href="#">
                        <i class="fas fa-bus-alt me-2"></i> Travel Booking
                    </a>
    ...
    <script src="{{ asset('js/penumpang/main.js') }}"></script>
    @yield('scripts')
</body>
</html>